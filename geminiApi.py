...
defined_word = "Please create a complete terraform script with shape: VM.Standard.E4.Flex , avilibility domain: AD1, Subnet: ocid1.subnet.oc1.iad.aaaaaaaau7vcvy63usiohq4ex2eyi4a3tdx76pyxkf4eeiz3wuvfugqkzcyq,Image: ocid1.image.oc1.iad.aaaaaaaa2bulxukxsjyv3ap3x45eueiqxxpxpsfrv6qppq7xrwtiima2c2pq block for oci vm."
prompt = defined_word 
